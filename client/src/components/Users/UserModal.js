...
import { FaTimes, FaSave, FaUser, FaEnvelope, FaLock, FaUserCog, FaUserMd, FaUser as FaUserIcon, FaEye, FaEyeSlash } from 'react-icons/fa';
...
const UserModal = ({ isOpen, onClose, user = null, onSave }) => {
  ...
  const getRoleIcon = (role) => {
    switch (role) {
      ...
      case 'patient': return <FaUserIcon className="h-4 w-4 text-green-600" />;
      default: return <FaUserIcon className="h-4 w-4 text-secondary-600" />;
    }
  };
